...
class GameGraphics:
    ...
    def draw_letters(self):
        ...
        for i in range(13):
            ...
            self.DISPLAYSURF.blit(letters, (x_circle_coord - (self.LETTER_FONT_SIZE / 4), self.y_circle_coord_row_1 - (self.LETTER_FONT_SIZE / 4)))  
            ...
            self.DISPLAYSURF.blit(letters, (x_circle_coord - (self.LETTER_FONT_SIZE / 4), self.y_circle_coord_row_2 - (self.LETTER_FONT_SIZE / 4)))         
            x_circle_coord = x_circle_coord + self.TOTAL_WIDTH
